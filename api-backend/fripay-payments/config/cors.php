...
return [
    ...
    |
    | Note : En production, remplacer allowed_origins par les origines
    | réelles du front-end (ex: ['https://app.fripay.bj']).
    |
    */

    // Routes concernées par CORS (les webhooks agrégateurs y sont inclus)
    'paths' => ['api/*', 'up'],
